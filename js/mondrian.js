function setup() { "use strict";
    ...
    var slider1 = document.getElementById('xSlider');
    slider1.value = 50;
    var slider2 = document.getElementById('ySlider');
    slider2.value = 50;
    var button1 = document.getElementById('regenerate');
