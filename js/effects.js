window.onscroll = function(){
    var scrollRatio = (document.body.scrollTop || document.body.parentNode.scrollTop) / (document.body.parentNode.scrollHeight - document.body.parentNode.clientHeight ) * 100;
    if(scrollRatio < 25)
   {
       console.log("in header, fadeRatio: " + scrollRatio);
       window.document.getElementById("percentage").style.opacity = (scrollRatio / 100) * 4;
...
function randSketch() {
        const sketches = ["T1", "T2", "T3", "T4", "T5", "T6", "T7", "T8", "T9", "T10", "A1", "A2", "A3", "A4", "A5", "A6", "A7", "A8", "A9", "A10"];
...
function select(color) {
    selected = color;
    if(selected == "rButton") {
        document.getElementById('rButton').src = "style/images/buttons/rButton-selected.png";
        document.getElementById('yButton').src = "style/images/buttons/yButton.png";
        document.getElementById('gButton').src = "style/images/buttons/gButton.png";
        document.getElementById('bButton').src = "style/images/buttons/bButton.png";
        var video = document.getElementsByClassName("video");
        for(let i = 0; i < video.length; i++) { video[i].style.cssText = grayscaleOff; }
        var graphic = document.getElementsByClassName("graphic");
        for(let i = 0; i < graphic.length; i++) { graphic[i].style.cssText = grayscaleOn; }
        var app = document.getElementsByClassName("app");
        for(let i = 0; i < app.length; i++) { app[i].style.cssText = grayscaleOn; }
        var music = document.getElementsByClassName("music");
        for(let i = 0; i < music.length; i++) { music[i].style.cssText = grayscaleOn; }
    }
    else if(selected == "yButton") {
            document.getElementById('yButton').src = "style/images/buttons/yButton-selected.png";
            document.getElementById('rButton').src = "style/images/buttons/rButton.png";
            document.getElementById('gButton').src = "style/images/buttons/gButton.png";
            document.getElementById('bButton').src = "style/images/buttons/bButton.png";
            var video = document.getElementsByClassName("video");
            ...
            document.getElementById('gButton').src = "style/images/buttons/gButton-selected.png";
            document.getElementById('yButton').src = "style/images/buttons/yButton.png";
            document.getElementById('rButton').src = "style/images/buttons/rButton.png";
            document.getElementById('bButton').src = "style/images/buttons/bButton.png";
            var video = document.getElementsByClassName("video");
      ...
      document.getElementById('bButton').src = "style/images/buttons/bButton-selected.png";
      document.getElementById('yButton').src = "style/images/buttons/yButton.png";
      document.getElementById('rButton').src = "style/images/buttons/rButton.png";
      document.getElementById('gButton').src = "style/images/buttons/gButton.png";  
      var video = document.getElementsByClassName("video");
